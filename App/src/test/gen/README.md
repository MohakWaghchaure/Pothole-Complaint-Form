...
- API version: 1.0
  - Build date: 2024-05-19T17:12:39.277225100-07:00[America/Los_Angeles]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**getComplaints**](docs/DefaultApi.md#getComplaints) | **GET** /complaints | 
*DefaultApi* | [**postComplaint**](docs/DefaultApi.md#postComplaint) | **POST** /complaints | 


## Documentation for Models

 - [Error](docs/Error.md)
 - [PotholeComplaint](docs/PotholeComplaint.md)
